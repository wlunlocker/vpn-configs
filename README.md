...
| 🌐 **WHITE SNI RU**/АНТИГЛУШИКИ #1 (SNI) | Конфигурации, отфильтрованные по SNI доменам для обхода блокировок по именам сайтов | `https://raw.githubusercontent.com/wlunlocker/vpn-configs/main/white_sni_ru.txt` |
